...
ActiveRecord::Schema[7.0].define(version: 2024_02_18_122045) do
  ...
  create_table "shipping_informations", charset: "utf8", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["buy_id"], name: "index_shipping_informations_on_buy_id"
  end
  ...
  add_foreign_key "shipping_informations", "buys"
end
